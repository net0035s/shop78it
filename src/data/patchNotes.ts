...
export const patchNotes: PatchNote[] = [
  {
    version: 'v1.0.8',
    date: '2026-06-17',
    title: 'รีดีไซน์หน้าต่างรายละเอียดสินค้า',
    tags: ['UI', 'UX', 'Product'],
    changes: [
      'ปรับปรุง Product Modal ให้ดูทันสมัย อ่านง่าย และมีระยะห่างของเนื้อหาชัดเจนขึ้น',
      'ปรับส่วนรายละเอียดสินค้าให้เป็นข้อความโล่งพร้อมเส้นคั่นแทนกล่องกรอบทึบ',
      'ปรับส่วนวิธีใช้งานเป็นกล่องคู่มือสีเข้ม และปรับสิ่งที่จะได้รับเป็นรายการพร้อมไอคอนเครื่องหมายถูก',
      'เพิ่มความโดดเด่นให้ราคา สถานะสินค้า และปุ่มหยิบใส่ตะกร้าด้วย hover/glow effect',
    ],
  },
  {
    version: 'v2.6-update',
